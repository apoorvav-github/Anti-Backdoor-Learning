...
def test(opt, test_clean_loader, test_bad_loader, model_ascent, criterion, epoch):
    ...
    print("...Writing the test metrics into csv file...")
    test_process.append(
    ...
    print("...Completed writting into the csv file...")
...
def main():
    ...
    parser.add_argument('--isolation_model_root', type=str, default=google_drive_path+'weight/backdoored_model/WRN-16-1-gridTrigger-targetLB0.tar',
                        help='path of backdoored model')
    parser.add_argument('--isolate_data_root', type=str, default=google_drive_path+'isolation_data/demo_data/WRN-16-1-isolation1%-examples.npy',
                        help='path of isolated data')
    parser.add_argument('--model_name', type=str, default='WRN-16-1',
                        help='model name')
    parser.add_argument('--dataset', type=str, default='CIFAR10', help='name of image dataset')
    parser.add_argument('--unlearning_root', type=str, default = google_drive_path + 'weight/Pretrained_model', help='path to save model')
