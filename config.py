...
def get_arguments():
    ...
    parser.add_argument('--unlearning_root', type=str, default='./weight/unlearn_model',
                        help='unlearning models weight are saved here')
    parser.add_argument('--checkpoint_root', type=str, default='./weight/isolation_model/WRN-16-1_BadNet_tuning_epochs5.tar',
    ...
    parser.add_argument('--isolate_model_root', type=str, default='./weight/isolation_model',
